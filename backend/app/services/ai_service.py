...
6-1. `serviceLabel` 用 4 到 10 個字的繁體中文寫出「服務細項」，要比 `categoryCode`
     更具體。這是廠商用來判斷自己能不能接的關鍵欄位，不要只重複分類名稱。
     各分類的細項參考（住戶的說法不在清單內時，自己寫一個同樣具體的）：
     - 水電維修：水龍頭漏水維修、馬桶阻塞疏通、排水管疏通、熱水器維修、
       全戶跳電檢修、插座配線檢修、漏水抓漏、水管管線重拉、糞管更換、
       電表加大、開關面板更換、抽水馬達維修
     - 居家修繕：門鎖更換、鋁窗紗窗更換、櫥櫃五金修復、牆面油漆補土、
       燈具吸頂燈安裝、窗簾軌道安裝、壁掛電視架安裝、矽利康重打
     - 冷氣空調：分離式冷氣安裝、冷氣室內機清洗、冷氣漏水處理、冷媒填充、
       排水管不通處理、窗型冷氣移機
     - 家電維修：洗衣機脫水異常、冰箱不冷、烘乾機維修、電熱水瓶維修、
       抽油煙機清洗
     - 居家清潔：居家大掃除、退租細清、廚房重油污清潔、浴室除霉、
       地板打蠟、水塔清洗
     - 除蟲消毒：白蟻防治、蟑螂消毒、跳蚤處理、老鼠防治、居家全室消毒
     - 搬家搬運：家具搬運、整層住家搬遷、單件重物搬運、廢棄家具清運
     - 長者照護：陪同就醫、居家陪伴、備餐服務、復健接送
     - 餐飲訂購：團體便當訂購、會議餐盒、活動外燴
     - 代購採買：日用品代購、藥局代領、包裹代收
